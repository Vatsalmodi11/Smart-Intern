...
const Courses: React.FC = () => {
    ...
    const handlePayment = (course: { title: string; price: string }) => {
        ...
        const options = {
            key: 'rzp_test_POhX2vlZ5FYdVA', // Replace with your actual Razorpay Test Mode Key ID
            amount: priceInINR,
            currency: 'INR',
            name: 'Smart Interns',
  ...
  <div className="max-w-7xl mx-auto px-4">
    ...
    >
      {[
        'https://public.readdy.ai/ai/img_res/336b5a7a9c9c8356174006a2481dc48f.jpg',
        'https://public.readdy.ai/ai/img_res/fd966c7acba893de8f95757441d64f9e.jpg',
        'https://public.readdy.ai/ai/img_res/4c26a234f4952569f65930e1e982a1c9.jpg',
        'https://public.readdy.ai/ai/img_res/855c803cf5df7dfb469a29f4e74373f4.jpg',
        'https://public.readdy.ai/ai/img_res/12b85ecd55b8fe98e7966231443a5ccd.jpg',
        'https://public.readdy.ai/ai/img_res/ca0f7bc180ba9778120e2b168e4ceed2.jpg',
      ].map((imageUrl, index) => (
      ...
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
        ...
        <div className="space-y-4">
          <h3 className="text-xl font-bold tracking-tight">Smart Interns</h3>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            <li><a href="/Courses" className="text-gray-400 hover:text-white transition-colors duration-200">Find Job</a></li>
            <li><a href="/jobs" className="text-gray-400 hover:text-white transition-colors duration-200">Courses</a></li>
            <li><a href="/Careers" className="text-gray-400 hover:text-white transition-colors duration-200">Career</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            <li className="text-gray-400">
              Email: <a href="mailto:info@learntech.com" className="hover:text-white transition-colors duration-200">info@SmartInterns.com</a>
            </li>
        ...
        <div>
          ...
          <form className="flex flex-col sm:flex-row gap-2">
            <input
              ...
              className="px-4 py-2 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-200 w-full"
            />
            <button
              type="submit"
              className="px-4 py-2 bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:outline-none transition-all duration-200 whitespace-nowrap"
            >
              Subscribe
            </button>
          </form>
      ...
      <div className="mt-10 border-t border-gray-800 pt-6 text-center text-gray-500 text-sm">
        <p>&copy; 2025 Smart Interns. All Rights Reserved.</p>
      </div>
    </footer>
