...
const Navbar = () => {
  ...
  useEffect(() => {
    const checkLoginStatus = () => {
      ...
      setIsLoggedIn(!!userId); // Convert to boolean: true if userId exists, false otherwise
    };

    checkLoginStatus(); // Initial check
    window.addEventListener('storage', checkLoginStatus); // Listen for changes across tabs
    window.addEventListener('loginEvent', checkLoginStatus); // Custom event for in-tab updates
